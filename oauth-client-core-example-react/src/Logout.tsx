...
export const Logout = () => {
  const logoutAction = client.config.logout_endpoint;
  const [csrf, setCsrf] = useState("");
  const postLogoutUri = client.config.post_logout_redirect_uri;
  ...
  return (
    <form method="POST" action={logoutAction} ref={formRef} hidden={true}>
