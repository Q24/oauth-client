...
export const OidcProvider = ({
  ...
  const refreshAuthStatus = useCallback(
    () => obtainSession().then(() => setIsAuthenticated(true)),
    []
  );
...
const useAutomaticLogout = ({
  ...
  //           window.location.href = oidcclient.config.post_logout_redirect_uri;
  //         });
  //       }
  //     }, autoLogout);
  //     return () => {
  ...
  //     };
  //   }
  // }, [autoLogout, isAuthenticated, oidcclient.config.post_logout_redirect_uri]);
};
