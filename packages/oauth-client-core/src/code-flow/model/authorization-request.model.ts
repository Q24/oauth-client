...
/**
 * The Normal Code flow parameters in addition to a new code challenge
 */
export interface OAuthPKCEAuthorizeParameters
  extends OAuthCodeFlowAuthorizeParameters {
  /**
